      ...
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row'>
          ...
          className='flex-1 border rounded-2xl flex flex-col gap-y-6 pb-24 p-6 items-start'>
            ...
            <textarea className='bg-transparent border-b py-12 outline-none w-full placeholder:text-white focus:border-accent transition-all resize-none mb-12' placeholder='Your messege'></textarea>
            <button className='btn btn-lg'>Send a messege</button>
          </motion.form>
        </div>
      </div>
    </section>
